...
The original skill instructions, summaries, and translations are available under the [MIT License](LICENSE). Linked Apple documentation, fonts, icons, UI kits, and other third-party resources remain under their respective terms; they are not redistributed in this skill.
